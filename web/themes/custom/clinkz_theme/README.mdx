...
clinkz_theme theme uses [Webpack](https://webpack.js.org) to compile and
bundle SASS and JS.
...
Go to the root of clinkz_theme theme and run the following commands:
`nvm use`
...
`drush en clinkz_theme -y`
`drush config-set system.theme default clinkz_theme -y`
